...
class Places_LT(object):
    def __init__(self, distributed, root="", batch_size=60, num_works=40, train_rule = 'BalancedRS'):
        ...
        if train_rule == 'None':
            ...
            balance_sampler = BalancedDatasetSampler(train_dataset)
        elif train_rule == 'EffectNumRS':
            balance_sampler = EffectNumSampler(train_dataset)
